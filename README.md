...
```javascript
import iterUnique from 'https://cdn.jsdelivr.net/gh/stdlib-js/iter-unique@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/iter-unique/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/iter-unique/actions/workflows/test.yml?query=branch:v0.2.2
